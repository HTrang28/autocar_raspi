"""
-Mô-đun này nhận các giá trị cần điều khiển
và đưa chúng vào một từ điển duy nhất trong thời gian thực.
-Các giá trị có thể được truy cập thông qua các phím
-Được thử nghiệm trên PS4 Bluetooth và bộ điều khiển có dây
"""
...
def getJS(name=''):
    ...
    # để xóa phần tử 2 vì số trục là 0 1 3 4
